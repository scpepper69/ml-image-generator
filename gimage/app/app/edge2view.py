...
#        image_bgr = cv2.fastNlMeansDenoisingColored(image_bgr,None,10,10,7,21) #add
        image_bgr = cv2.resize(image_bgr, (512,512))  # Add
        print(image_bgr.shape)
